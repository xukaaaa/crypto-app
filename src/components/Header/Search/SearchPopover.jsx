...
function SearchPopover() {
    ...
    const render = (attrs) => (
        <div className="w-[400px] rounded-lg bg-white shadow-headerSearch" tabIndex="-1" {...attrs}>
            ...
            <div className="py-2">
                ...
                {searchResult && (
                    <div className="px-2">
                        <p className="mb-2 flex items-stretch pl-2 text-xs text-[#808a9d]">Cryptoassets</p>
